...
- **weekly RSV hospitalisation incidence** (i.e., new admissions) for each modelled country by age group (0-2mo, 3-5mo, 6-11mo, 1-4y, 5-64y, 65+y, total) and immunisation status (yes, no, total) betweeen September $1^{st}$, 2025 and May $31^{st}$, 2026. This target is **mandatory**.
- **weekly administered doses** for each modelled country betweeen September $1^{st}$, 2025 and May $31^{st}$, 2026. In the case of la-mAbs, this target should be reported as the number of doses administered to newborns, on a given week and country. In the case of MV, this target should be reported as the number of doses administered to pregnant individuals, on a given week and country. This target is **mandatory**.
- **weekly RSV infection incidence** (i.e., new infections) in each individual countries by age group (0-2mo, 3-5mo, 6-11mo, 1-4y, 5-64y, 65+y, total) and immunisation status (yes, no, total) betweeen September $1^{st}$, 2025 and May $31^{st}$, 2026. This target is **optional**.
...
- Immunisation effectiveness (IE) of la-mAbs is 87% (95% CI: 81-91%) against RSV-associated hospitalisations in infants based on meta-analysis presented in Ref. [14], which analyses effectiveness studies with follow-up duration between between four and eight months. IE of MV is 78.6% (95% CI: 62.1–87.9%) against RSV-associated hospitalisations in infants based on Ref. [15], which is a test-negative effectiveness study that included infants below six months through one RSV season. By the nature of effectiveness studies, both of these IE estimates inherently include the effect of waning immunity withing the follow-up period. We strongly encourage teams to include the uncertainty in the IE estimates in their modelling. For example, teams may sample IE values from the provided IE estimates and their uncertainty to generate scenario projections. 
- We assume no shortage of la-mAbs or MV in the EU/EEA at any time during the scenario period.
- The focus group for the universal intervention should be the newborns, and we aim to hamonise across the two immunisation options. Thus, immunisation coverage during intervention period should be as stated in the scenario table. We assume that immunisation campaigns are implemented in such a way that the first immunised infants are born on September $1^{st}$ and the last immunised infants are born on March $31^{st}$ of the next year. We leave it to the teams to decide on the time-varying coverage of the interventions, in the simplest case, this can be done by assuming a constant coverage over the intervention period. Different implementation strategies are allowed as long as the coverage over the birth cohort in the intervention period (i.e., percentage of newborns immunised out of all babies born between $1^{st}$ September 2025 and $31^{st}$ of March, 2026) is consistent with the scenario axes, and as long as the time varying coverage is identical between the two immunisation options for a given pair of scenarios (i.e., A and C, B and D).
...
- We acknowledge that fetal, perinatal, and neonatal mortality may have a minor effect on immunisation coverage and impact of maternat vaccination programmes. However, these rates are very low (less than 1%; see [17]) and can therefore reasonably be considered negligible by teams for the purposes of this scenario round.
