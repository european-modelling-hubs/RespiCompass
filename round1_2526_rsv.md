...
- Immunisation effectiveness (IE) of la-mAbs is 87% (95% CI: 81-91%) against RSV-associated hospitalisations in infants based on meta-analysis presented in Ref. [X]. IE of MV is XX% (95% CI: XX-XX) against RSV-associated hospitalisations in infants. We strongly encourage teams to include the uncertainty in the IE estimates in their modelling. For example, teams may sample values VE from the provided IE estimates and their uncertainty to generate scenario projections. 
...
14. Reeves, R.M., van Wijhe, M., Lehtonen, T., Stona, L., Teirlinck, A.C., Vazquez Fernandez, L., Li, Y., Osei-Yeboah, R., Fischer, T.K., Heikkinen, T. and Van Boven, M., 2022. A systematic review of European clinical practice guidelines for respiratory syncytial virus prophylaxis. The Journal of infectious diseases, 226(Supplement_1), pp.S110-S116. Available at: https://academic.oup.com/jid/article/226/Supplement_1/S110/6554001 
15. Eurostat. Fetal, peri- and neonatal mortality rates by country of occurrence. 2025. Available at: https://ec.europa.eu/eurostat/databrowser/view/hlth_cd_aperrto/default/table?lang=en. DOI: https://doi.org/10.2908/HLTH_CD_APERRTO
