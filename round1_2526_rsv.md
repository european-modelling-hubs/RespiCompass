...
- Immunisation effectiveness (IE) of la-mAbs is 87% (95% CI: 81-91%) against RSV-associated hospitalisations in infants based on meta-analysis presented in Ref. [14]. IE of MV is XX% (95% CI: XX-XX) against RSV-associated hospitalisations in infants based on Ref. [15]. We strongly encourage teams to include the uncertainty in the IE estimates in their modelling. For example, teams may sample values VE from the provided IE estimates and their uncertainty to generate scenario projections. 
